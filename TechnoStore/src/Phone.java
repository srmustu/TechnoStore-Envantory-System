public class Phone {
    ...
    public Phone(int id, Brand brand, String name, String color, int price, int discountRate, int stockQuantity, int gbTypeMemory, double screenSize, int batterySize, int gbTypeRam) {
        this.id = id;
        this.brand = brand;
        this.name = name;
        this.color = color;
